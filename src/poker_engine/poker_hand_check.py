...
from poker import Card, Combo, Rank
...
def eval_hand(hand):
    ...
    if len(score) == 5:
        ...
        # adjust if 5 high straight ["A", "2", "3", "4", "5"]
        if ranks[0:2] == (card_order_dict[Rank.ACE], card_order_dict[Rank.FIVE]):
            ranks = (
                card_order_dict[Rank.FIVE],
                card_order_dict[Rank.FOUR],
                card_order_dict[Rank.THREE],
                card_order_dict[Rank.DEUCE],
                1
            )
...
def check_royal_flush(hand):
    if check_flush(hand) and check_straight(hand):
        ...
        return bool(set(values).issuperset(set(["T", "J", "Q", "K", "A"])))
    else:
        return False
...
def check_four_of_a_kind(hand):
    ...
    for v in values:
        value_counts[v] += 1
    return bool(4 in value_counts.values())
...
def check_full_house(hand):
    ...
    for v in values:
        value_counts[v] += 1
    return bool(2 in value_counts.values() and 3 in value_counts.values())
...
def check_flush(hand):
    ...
    for s in suits:
        suit_counts[s] += 1
    return bool(5 in suit_counts.values())
...
def check_three_of_a_kind(hand):
    ...
    for v in values:
        value_counts[v] += 1
    return bool(3 in value_counts.values())
...
def check_two_pairs(hand):
    ...
    for v in values:
        value_counts[v] += 1
    return bool(list(value_counts.values()).count(2) == 2)
...
def check_one_pairs(hand):
    ...
    for v in values:
        value_counts[v] += 1
    return bool(list(value_counts.values()).count(2) == 1)
